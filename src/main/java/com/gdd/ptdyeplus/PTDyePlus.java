...
import com.gdd.ptdyeplus.content.contraptions.WinchContraptionRenderer;
import com.gdd.ptdyeplus.content.contraptions.behaviour.ThrusterMovementBehaviour;
...
public class PTDyePlus {
    ...
    public static class ClientModBusEvents {
        ...
        public static void commonSetup(FMLCommonSetupEvent event) {
            // Register insert into other mods
            event.enqueueWork(() -> {
                // Create
                MovementBehaviour.REGISTRY.register(BlockInit.THRUSTER.get(), new ThrusterMovementBehaviour());
                MovementBehaviour.REGISTRY.register(BlockInit.INVISIBLE_SEAT.get(), new SeatMovementBehaviour());
            });
        }
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            event.enqueueWork(() -> {
                SimpleEntityVisualizer.builder(EntityInit.INDEPENDENT_CONTRAPTION.get())
                    ...
                    .apply();
                SimpleEntityVisualizer.builder(EntityInit.WINCH_CONTRAPTION.get())
                    .factory(ContraptionVisual::new)
                    .skipVanillaRender(entity -> false)
                    .apply();
            });
        ...
        public static void registerRenders(EntityRenderersEvent.RegisterRenderers event) {
            ...
            event.registerEntityRenderer(EntityInit.WINCH_CONTRAPTION.get(), WinchContraptionRenderer::new);
        }
    }
